        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50/50 p-6 md:p-8 rounded-2xl mt-10 border border-blue-100">
            ...
            <p className="text-lg text-gray-800 leading-relaxed">
              בדפוס כתר, אנו משלבים את היתרונות של מדע האופסט עם טכנולוגיה מתקדמת. כאשר אתם זקוקים לכמויות גדולות (מעל 1,000 עותקים), מחלקת האופסט שלנו נכנסת לפעולה. אנו משתמשים בלוחות אלומיניום איכותיים ובמערכות בקרת צבע אוטומטיות (CTP - Computer to Plate) המבטיחות התאמה מושלמת של הדימוי המודפס למקור. השילוב של מכונות מתקדמות, ידע כימי מעמיק ובקרת איכות קפדנית מאפשר לנו לספק תוצאות עילאיות, כולל הדפסת צבעי פנטון, צבעים מטאליים וזהב, במחיר תחרותי ובמהירות שיא.
            </p>
          </div>
        </div>
      </article>
